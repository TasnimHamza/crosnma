...
#' @param ... \dots
#'
#'@return returns a matrix containing the following summary statistics (in columns) for each estimated parameter:
#'@return Mean the mean of the posterior distribution
#'@return SD the standard deviation of the posterior distribution
#'@return 2.5% the 2.5% quantile of the posterior distribution (the lower bound of the 95% credible interval)
#'@return 50% the median of the posterior distribution
#'@return 97.5% the 97.5% quantile of theposterior distribution (the upper bound of the 95% credible interval)
#'@return Rhat Gelman-Rubin statistic. The further the value from 1, the worse the mixing of chains and so the convergence.
#'@return n.eff an estimate of the effective sample size. The smaller the value, the greater the uncertanity associated with the corresponding parameter.
#' @export
#'
